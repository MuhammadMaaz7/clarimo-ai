...
async def process_user_input_background(
    ...
    try:
        ...
        try:
            ...
            from app.services.problem_discovery.embedding_service import embedding_service
            from app.services.problem_discovery.semantic_filtering_service import semantic_filtering_service
            ...
            from app.services.problem_discovery.clustering_service import clustering_service
