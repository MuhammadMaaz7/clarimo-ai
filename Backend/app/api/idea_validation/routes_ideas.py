...
async def create_idea(
    ...
    try:
        ...
        idea = IdeaManager.create_idea(user_id, idea_data)
        return idea
...
async def update_idea(
    ...
    """
    user_id = current_user.id
    updated_idea = IdeaManager.update_idea(user_id, idea_id, updates)
...
async def delete_idea(
    ...
    """
    user_id = current_user.id
    success = IdeaManager.delete_idea(user_id, idea_id)
