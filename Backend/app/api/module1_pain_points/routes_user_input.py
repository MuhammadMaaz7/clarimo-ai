...
async def process_user_input_background(
    ...
    try:
        ...
        try:
            ...
            from app.services.module1_pain_points.keyword_generation_service import KeywordGenerationService
            from app.services.module1_pain_points.reddit_fetching_service import reddit_fetching_service
            from app.services.module1_pain_points.embedding_service import embedding_service
            from app.services.module1_pain_points.semantic_filtering_service import semantic_filtering_service
...
async def delete_analysis_records(
    ...
    try:
        ...
        try:
            from app.services.module1_pain_points.pain_points_db_service import pain_points_db_service
