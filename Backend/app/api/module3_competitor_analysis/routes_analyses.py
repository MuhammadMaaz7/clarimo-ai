...
from app.services.module3_competitor_analysis.analysis_service import CompetitorAnalysisService
...
async def start_analysis(
    ...
    try:
        ...
        analysis = await CompetitorAnalysisService.start_analysis(
...
async def get_analysis_result(
    ...
    try:
        ...
        analysis = CompetitorAnalysisService.get_analysis_result(
...
async def get_analysis_status(
    ...
    try:
        ...
        status_info = CompetitorAnalysisService.get_analysis_status(
            analysis_id=analysis_id,
            user_id=user_id
        )
...
async def get_analysis_history(
    ...
    try:
        ...
        history = CompetitorAnalysisService.get_analysis_history(
