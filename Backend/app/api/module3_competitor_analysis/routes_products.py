...
from app.services.module3_competitor_analysis.product_service import ProductService
...
async def create_product(
    ...
    try:
        ...
        product = ProductService.create_product(user_id, product_data)
        return product
...
async def get_product(
    ...
    try:
        user_id = current_user.id
        product = ProductService.get_product(user_id, product_id)
...
async def update_product(
    ...
    try:
        user_id = current_user.id
        product = ProductService.update_product(user_id, product_id, product_data)
...
async def delete_product(
    ...
    try:
        user_id = current_user.id
        deleted = ProductService.delete_product(user_id, product_id)
