...
from app.services.module1_pain_points.embedding_service import get_global_model
...
class ClusteringService:
    ...
    def _load_existing_embeddings(self, user_id: str, input_id: str, posts: List[Dict]) -> np.ndarray:
        ...
        try:
            ...
            from app.services.shared.optimized_embedding_cache import get_global_embedding_cache
    ...
    async def cluster_filtered_posts(
        ...
        try:
            ...
            try:
                ...
                from app.services.module1_pain_points.pain_points_service import pain_points_service
                ...
                if pain_points_success:
                    ...
                    try:
                        ...
                        from app.services.module1_pain_points.ranking_service import ranking_service
