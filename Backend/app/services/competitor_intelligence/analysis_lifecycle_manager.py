...
class AnalysisLifecycleManager:
    ...
    async def start_analysis(
        ...
        background_tasks.add_task(
            AnalysisLifecycleManager._execute_analysis_background,
            analysis_id,
            product
        )
    ...
    async def _execute_analysis_background(analysis_id: str, product: dict):
        ...
        try:
            ...
            # Import services
            from app.services.competitor_intelligence.producthunt_data_fetcher import get_producthunt_fetcher
            from app.services.competitor_intelligence.google_competitor_finder import get_google_finder
            from app.services.idea_validation.market_data_fetcher import MarketDataFetcher
            from app.services.competitor_intelligence.keyword_generator import KeywordGenerator
            from app.services.competitor_intelligence.fallback_keyword_extractor import FallbackKeywordExtractor
            from app.services.competitor_intelligence.analysis_data_persister import AnalysisDataPersister
            from app.services.competitor_intelligence.competitor_web_scraper import get_web_scraper
            ...
            llm_result = await KeywordGenerator.generate_competitor_keywords(
            ...
            if llm_result.get("success"):
                ...
                keywords = FallbackKeywordExtractor.extract_keywords(
                    product_name=product_name,
                    product_description=product_description,
                    key_features=key_features,
                    max_keywords=5
            ...
            AnalysisDataPersister.save_keywords(
                analysis_id=analysis_id,
                product_name=product_name,
                keywords=keywords,
            ...
            # 1. Product Hunt
            try:
                ph_service = get_producthunt_fetcher()
                ...
                AnalysisDataPersister.save_competitors(
                    analysis_id=analysis_id,
                    product_name=product_name,
            ...
            try:
                external_service = MarketDataFetcher()
            ...
            try:
                google_service = get_google_finder()
            ...
            from app.services.competitor_intelligence.competitor_classifier import CompetitorClassifier
            ...
            AnalysisDataPersister.save_full_analysis(
                analysis_id=analysis_id,
                product_name=product_name,
