...
def get_producthunt_fetcher() -> ProductHuntDataFetcher:
    """Get singleton instance of ProductHuntDataFetcher"""
    global _product_hunt_service
    if _product_hunt_service is None:
        _product_hunt_service = ProductHuntDataFetcher()
