...
def get_google_finder() -> GoogleCompetitorFinder:
    """Get singleton instance of GoogleCompetitorFinder"""
    global _google_search_service
    if _google_search_service is None:
        _google_search_service = GoogleCompetitorFinder()
