...
class IdeaManagementService:
    ...
    def create_idea(user_id: str, idea_data: IdeaCreate) -> IdeaResponse:
        ...
        idea_dict = {
            ...
            "linked_pain_points": idea_data.linked_pain_point_ids or [],
            "created_at": now,
            "updated_at": now,
            "validation_count": 0,
    ...
    def get_idea(user_id: str, idea_id: str) -> Optional[IdeaResponse]:
        ...
        return IdeaManagementService._populate_latest_validation(idea_response)
    ...
    def list_ideas(
        ...
        if sort_by_validation_score:
            ...
            for doc in cursor:
                ...
                ideas.append(IdeaManagementService._populate_latest_validation(idea_response))
    ...
    def update_idea(
        ...
        """
        # Get existing idea
        existing_idea = IdeaManagementService.get_idea(user_id, idea_id)
        ...
        # Handle linked_pain_point_ids -> linked_pain_points conversion
        if "linked_pain_point_ids" in update_dict:
            update_dict["linked_pain_points"] = update_dict.pop("linked_pain_point_ids")
        ...
        # Return updated idea
        return IdeaManagementService.get_idea(user_id, idea_id)
